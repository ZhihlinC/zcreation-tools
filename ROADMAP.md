...
- ✅ **M3.E** — Layout Health panel + region 偵測 + 動態警示（2026-05-05）
- ⬜ M3.F — 三角形 hover tooltip（圖層 toggle 啟用已隨 M3.A/B/E 完成）
- ⬜ M3.G — 視覺檢核（下方清單）
...
**最後更新**：2026-05-05（M3.E 完成：Layout Health panel + region 偵測 + 動態警示 + 61 headless tests；M3.F 待續）
