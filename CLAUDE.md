...
| M5 — i18n / landing / 公開化 | 中英切換、mobile banner、landing page、meta / OG、open source | 預計 1 週 |
...
**最後更新**：2026-05-06（M4 全部完成：A → C 三階段；self-contained HTML round-trip + 2× viewport PNG composite；M5 待續，含 M5.E 公開化收尾）
