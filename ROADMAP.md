...
- ✅ **M3.F** — 三角形 hover tooltip + 右下 layout 修正（2026-05-05）
- ⬜ M3.G — 視覺檢核（下方清單）；可選擇納入 M3 最終 commit 或單獨一輪
...
**最後更新**：2026-05-05（M3.F 完成：triangle hover tooltip + layout 修正 + 68 headless tests；M3.G 待續，M3 主體已完成）
