...
- ✅ **M3.B-β** — 球面凸包三角剖分（sliver pre-merge、種子四面體、horizon walk、manifold assert、視覺串接）（2026-05-05）
...
**最後更新**：2026-05-05（M3.B-β 完成：sliver merge + spherical hull + 24 headless tests；M3.C 待續）
