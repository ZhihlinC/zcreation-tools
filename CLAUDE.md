...
| **M3 — Layout Health** | Phantom speaker、球面三角化、健康度警示 | ✅ 2026-05-05（A→G 七階段、71 headless tests） |
| **M4 — 下載 / 上傳 / PNG** | self-contained HTML + 截圖 | ✅ 2026-05-06（A→C 三階段） |
| **M5.A–D — bilingual §2 / banner / landing / meta** | §2 中英雙呈現、mobile banner、landing polish、meta / OG / sitemap | ✅ 2026-05-07/08 |
| M5.E — 公開化收尾 | LICENSE + README 改寫 + repo public + `v1.0.0` tag | launch day |
...
**最後更新**：2026-05-08（M5.D done — `<head>` OG / Twitter card、SEO description、sitemap `<lastmod>` 補齊；剩 M5.E launch day）
